...
import { trainClusteringModels, getBestMLModel } from "@/utils/mlAlgorithms";
...
interface ClusteringTrainingProps {
  data: any[];
  features: string[];
  datasetName: string;
...
export function ClusteringTraining({
  data,
  features,
  datasetName,
  onTrainingComplete
}: ClusteringTrainingProps) {
  ...
  const handleStartTraining = async () => {
    ...
    try {
      ...
      const results = await trainClusteringModels(data, features);
  ...
  return (
    ...
    `}>
      <h2 className="text-2xl font-semibold mb-4">Clustering Training</h2>
      ...
      <div className="mb-6">
        ...
        `}>
          <div className="flex items-center gap-2 mb-3">
            ...
            <span className="font-medium">Unsupervised Clustering</span>
          </div>
          
          <p className="text-sm text-muted-foreground mb-3">
            Clustering algorithms group data points based on similarities without requiring labeled data.
          </p>
            ...
            <div className="space-y-3">
              ...
              <p className="text-sm text-muted-foreground">
                {isSaving 
                  ...
                  : "Training clustering algorithms to find natural groupings in your data"}
              </p>
            </div>
          )}
                  ...
                  <table className="w-full">
                    <thead>
                      ...
                      `}>
                        ...
                        <th className="px-4 py-3 text-sm font-medium text-right">Performance Score</th>
                      </tr>
                    </thead>
                    <tbody>
                    ...
                    <div>
                      ...
                      <p className={`
                        ...
                        ${theme === "light" 
                          ...
                          : "text-green-500"}
                      `}>
                        {(bestModel.accuracy * 100).toFixed(2)}% performance score
                      </p>
