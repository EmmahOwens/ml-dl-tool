...
import { trainAllMLModels, getBestMLModel } from "@/utils/mlAlgorithms";
...
export function MLTraining({
  ...
  const handleStartTraining = async () => {
    ...
    try {
      ...
      // Train all ML models
      const results = await trainAllMLModels(data, features, target);
  ...
  return (
    ...
    `}>
      <h2 className="text-2xl font-semibold mb-4">Machine Learning Training</h2>
                  ...
                  <table className="w-full">
                    <thead>
                      ...
                      `}>
                        ...
                        <th className="px-4 py-3 text-sm font-medium text-right">Accuracy</th>
                      </tr>
                    </thead>
                    <tbody>
                    ...
                    <div>
                      ...
                      <p className={`
                        ...
                        ${theme === "light" 
                          ...
                          : "text-green-500"}
                      `}>
                        {(bestModel.accuracy * 100).toFixed(2)}% accuracy
                      </p>
