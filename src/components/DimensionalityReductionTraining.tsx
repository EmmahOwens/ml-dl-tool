...
interface DimensionalityReductionTrainingProps {
  data: any[];
  features: string[];
  datasetName: string;
...
export function DimensionalityReductionTraining({
  data,
  features,
  datasetName,
  onTrainingComplete
}: DimensionalityReductionTrainingProps) {
  ...
  const handleStartTraining = async () => {
    ...
    try {
      ...
      const results = await trainDimensionalityReductionModels(data, features);
  ...
  return (
    ...
    `}>
      <h2 className="text-2xl font-semibold mb-4">Dimensionality Reduction</h2>
      ...
      <div className="mb-6">
        ...
        `}>
          <div className="flex items-center gap-2 mb-3">
            ...
            <span className="font-medium">Feature Extraction & Reduction</span>
          </div>
            ...
            <div className="space-y-3">
              ...
              <p className="text-sm text-muted-foreground">
                {isSaving 
                  ...
                  : "Evaluating dimensionality reduction techniques on your dataset"}
              </p>
            </div>
          )}
                  ...
                  <table className="w-full">
                    <thead>
                      ...
                      `}>
                        ...
                        <th className="px-4 py-3 text-sm font-medium text-right">Explained Variance</th>
                      </tr>
                    </thead>
                    <tbody>
                    ...
                    <div>
                      <h4 className={`
                        ...
                        ${theme === "light" 
                          ...
                          : "text-green-400"}
                      `}>
                        Best Technique: {bestModel.algorithm}
                      </h4>
                      <p className={`
                        text-sm mt-1
                        ${theme === "light" 
                          ...
                          : "text-green-500"}
                      `}>
                        {(bestModel.accuracy * 100).toFixed(2)}% explained variance
                      </p>
